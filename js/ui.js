...
function renderSidebar() {
  ...
  // Render sidebar bottom actions including QR import
  const sbb = document.querySelector('.sbb');
  if (sbb) {
    sbb.innerHTML = `
      <button class="sa" onclick="handleExport()">📤 Export JSON</button>
      <button class="sa" onclick="handleImport()">📥 Import JSON</button>
      <button class="sa" onclick="openQRImportModal()">📥 Import Pasien (Kode)</button>
