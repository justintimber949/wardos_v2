      ...
      <div class="cb">
        ...
        <div id="input-form" style="margin-top:10px">
          <div id="single-form-placeholder" style="text-align:center;padding:20px;color:var(--mu);font-size:12px">
            Parse teks di atas, atau <button class="bu bgh btn-form-pulse" style="font-size:11px;margin-left:5px" onclick="openFormModal(null,null,null)">+ Buka Form Kosong</button>
          </div>
        </div>
      </div>
    </div>
